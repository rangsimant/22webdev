...
@section('content')
<hr/>
<div class="col-md-7  col-xs-12  box-post">
	<div class="row">
		<div class="col-md-12">
	...
	<div class="row">
		...
		<div class="col-md-12">
			<img src="{{ $post->attachment }}" alt="" class="img-responsive thumbnail" style="min-width:100%;">
		</div>
		@endif
	</div>
	<hr/>
...
<div class="col-md-4 col-xs-12 box-post">
	<div class="col-md-12">
		<div id="vote" style="position: relative; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); height:325px"></div>
	</div>
</div>

<div class="col-md-4 col-xs-12 box-vote" align="center">
	@if (Auth::check())

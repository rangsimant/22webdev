...
<section class="panel panel-default table-dynamic">
	...
	<div class="panel-body">
		...
		{{ Form::open(array('url' => 'sensor','id'=>'form','class'=>'form-horizontal ng-pristine ng-valid','files' => true)) }}
            ...
            <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" data-rule="quantity" name="numberOfChannels">

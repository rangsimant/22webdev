...
{{ Form::open(array('url' => 'map', 'class' => 'form-horizontal form-validation', 'autocomplete' => 'off')) }}

	@if (Session::has('message'))
	    <div class="alert alert-{{ Session::get('message-type', 'info') }}">{{ Session::get('message') }}</div>
	@endif
    <div class="panel panel-default">
        <div class="panel-heading"><strong><span class="glyphicon glyphicon-th"></span> New Map</strong></div>

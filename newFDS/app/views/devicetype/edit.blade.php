...
{{ Form::model($devicetype, array('route' => array('devicetype.update', $devicetype->idDeviceType), 'method' => 'PUT', 'id' => 'form','class'=>'form-horizontal ng-pristine ng-valid','files' => true)) }}

@if (Session::has('message'))
    <div class="alert alert-{{ Session::get('message-type', 'info') }}">{{ Session::get('message') }}</div>
@endif
<input type="hidden" name="idDeviceType" value="{{ $devicetype->idDeviceType }}">
<div class="row">
    <div class="col-md-4">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body ng-scope">
	            	...
	            	<div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        <input name="name" type="text" placeholder="Device Type Name" value="{{ $devicetype->name }}" class="form-control ng-pristine ng-invalid ng-invalid-required" required="">
	                    </div>
	                </div>
	                    ...
	                    <div class="col-sm-10">
	                    	...
	                    	<div class="col-sm-6">
		                		...
		                		<label class="devicetype ui-checkbox">
		                			...
		                			@foreach($devicetype_sensor as $value)
		                				@if( $sensor->idSensor == $value->Sensor )
		                					checked
					                		<?php $numberOfChannel++; ?>
		                				@endif
		                			@endforeach
		                		...
		                		<span class="pull-right">
									...
									<span class="devicetype ui-select">
			                			<select name="sensor[{{ $idx }}][numberOfChannel]" class="ng-pristine ng-valid">
			                				@for($i = 1; $i <= $sensor->numberOfChannels; $i++)
			                					<option value="{{ $i }}"
				                				@if($numberOfChannel != -1 && $sensor->idSensor == $devicetype_sensor[$numberOfChannel]->Sensor )
				                					{{ (isset($devicetype_sensor[$numberOfChannel]) && $devicetype_sensor[$numberOfChannel]->numberOfChannel == $i)?'selected':'' }}
				                				@endif	
			                					> {{ $i }}</option>
			                				@endfor
			                			</select>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        <input name="manufacturer" type="text" placeholder="Manufacturer" value="{{ $devicetype->manufacturer }}" class="form-control ng-pristine ng-invalid ng-invalid-required" required="">
	                    </div>
	                </div>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        <input name="contactperson" type="text" placeholder="Name" value="{{ $devicetype->contactperson }}" class="form-control ng-pristine ng-invalid ng-invalid-required">
	                    </div>
	                </div>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        <textarea name="address" placeholder="Address" class="form-control ng-pristine ng-invalid ng-invalid-required">{{ $devicetype->address }}</textarea>
	                    </div>
	                </div>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        <input name="tel" type="text" placeholder="Telephone Number" value="{{ $devicetype->tel }}" class="form-control ng-pristine ng-invalid ng-invalid-required" onkeypress="return isNumberKey(event)" maxlength="10">
	                    </div>
	                </div>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        <input name="email" type="email" placeholder="Email" value="{{ $devicetype->email }}" class="form-control ng-pristine ng-invalid ng-invalid-required ng-invalid-email">
	                    </div>
	                </div>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        <textarea name="description" placeholder="Description" class="form-control ng-pristine ng-invalid ng-invalid-required">{{ $devicetype->description }}</textarea>
	                    </div>
	                </div>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                    	<a href="{{ URL::to('devicetype') }}" class="btn btn-default" style="margin-right: 10px;">Cancel</a>

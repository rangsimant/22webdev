						...
						$("form#login").validate({
							...
							submitHandler: function(form)
							{
								...
								$.ajax({
									...
									data: {
										do_login: true,
										inputEmail: $(form).find('#username').val(),
										inputPassword: $(form).find('#passwd').val(),
									},
				...
				<form method="post" role="form" id="login" class="login-form fade-in-effect">
					...
					<div class="login-header">
						<a href="dashboard-1.html" class="logo">
							<img src="http://placehold.it/80x80" alt="" width="80" />
							<span>log in</span>
						</a>
					...
					<div class="login-footer">
						<a href="{{ URL::to('users/forgot_password') }}">Forgot your password?</a>
